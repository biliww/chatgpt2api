...
from services.register.service import register_service
...
# 自注册到可选路由（merge 友好，无需改动 api/app.py 的 include 循环）
from api.feature_registry import register_optional_router  # noqa: E402

register_optional_router(create_router())
