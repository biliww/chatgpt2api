...
import type { RegisterConfig } from "@/lib/register-api";
...
function RegisterDataController() {
  ...
  const loadRegister = useRegisterStore((state) => state.loadRegister);
  const setRegisterConfig = useRegisterStore((state) => state.setRegisterConfig);
